...
public interface TaskService {
    List<TaskResponse> createTasks(UUID activityId, CreateTaskRequest request, UUID fieldOfficerId);
    ...
    TaskResponse updateTask(UUID taskId, UpdateTaskRequest request, UUID fieldOfficerId);
